...
import { JobQueue, getJobStore } from '../../jobs';
 ...
 */
export async function collectMetrics(queue?: JobQueue): Promise<SLOMetrics> {
 ...
 */
function checkThreshold(value: number, warnThreshold: number, criticalThreshold: number): SLOStatus {
 ...
 */
function evaluateQueueSize(metrics: SLOMetrics, thresholds: SLOThresholds): SLOCheckResult {
 ...
 */
function evaluateWaitingApproval(metrics: SLOMetrics, thresholds: SLOThresholds): SLOCheckResult {
 ...
 * Evaluate DLQ SLO
 */
function evaluateDLQ(metrics: SLOMetrics, thresholds: SLOThresholds): SLOCheckResult {
 ...
 */
function evaluateFailureRate(metrics: SLOMetrics, thresholds: SLOThresholds): SLOCheckResult {
 ...
 */
function evaluateCircuitBreakers(metrics: SLOMetrics, thresholds: SLOThresholds): SLOCheckResult {
 ...
 */
export function evaluateSLOsSync(metrics: SLOMetrics, thresholds?: SLOThresholds): SLOEvaluationResult {
